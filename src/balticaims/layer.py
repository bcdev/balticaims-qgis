...
class DataCubeLayer(QgsRasterLayer):
    ...
    def __init__(self, ds: xr.Dataset, name: str, display_name: str | None=None, max_time_steps: int | None=None):
        self.ds = ds
    ...
    @staticmethod
    def interpolate_color_ramp(color_ramp_data, color_ramp_min=0, color_ramp_max=255):
